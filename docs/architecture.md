# Playful Sincerity Digital Core — Three-Layer Architecture
...
|-----------|----------|---------|
| Global CLAUDE.md | `~/.claude/CLAUDE.md` | Ecosystem map — all 35 projects, clusters, cross-project relationships. Auto-loads every conversation |
...
| Component | Location | Purpose |
|-----------|----------|---------|
| Skills | `skills/` (20 skills) | Executable capabilities invoked via /command |
...
| Debate protocol | `knowledge/debate-protocol.md` | Multi-agent adversarial analysis engine — escalation, synthesis, asymmetry detection |
